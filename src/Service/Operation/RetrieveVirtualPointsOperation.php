...
final class RetrieveVirtualPointsOperation
{
    ...
    public function __construct(
        private readonly RetrieveClassementOperation $retrieveClassementOperation,
        private readonly ListPartieOperation $listPartieOperation,
        ...
        try {
            ...
            foreach ($unvalidatedParties as $unvalidatedParty) {
                ...
                if (!$unvalidatedParty->isForfait()) {
                    ...
                    } catch (InvalidResponseException|InvalidRequestException) {
                        $adversairePoints = $unvalidatedParty->getAdversaireClassement();
                    }
